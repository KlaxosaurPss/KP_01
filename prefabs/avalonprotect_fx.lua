local assets =
{
    Asset("ANIM","anim/avalonprotect_fx.zip"),
}
...
local function ceprotectfx_fn()
    ...
    inst.AnimState:SetBank("avalonprotect_fx")
    inst.AnimState:SetBuild("avalonprotect_fx")
    ...
    inst._lightframe = net_tinybyte(inst.GUID, "avalonprotect_fx._lightframe", "lightdirty")
    inst._islighton = net_bool(inst.GUID, "avalonprotect_fx._islighton", "lightdirty")
    inst._lighttask = nil
...
return Prefab("avalonprotect_fx", ceprotectfx_fn, assets)